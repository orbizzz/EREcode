...
model_path = "/content/drive/MyDrive/ViT-cifar10-pruning/checkpoint/vit11-4-ckpt_l1movement_cos_999.t7"
...
if select == 0:
    model_name = "pruned_l1movement_cos_999_no_mag_{}.pth".format(percent)
    torch.save(newmodel.state_dict(), model_name)
if select == 1:
    model_name = "pruned_l1movement_cos_999_no_magfisher_{}.pth".format(percent)
    torch.save(newmodel.state_dict(), model_name)
if select == 2:
    model_name = "pruned_l1movement_cos_999_no_fisher_{}.pth".format(percent)
    torch.save(newmodel.state_dict(), model_name)
if select == 3:
    model_name = "pruned_l1movement_cos_999_no_taylor_{}.pth".format(percent)
    torch.save(newmodel.state_dict(), model_name)
